          ...
          <div class="col-lg-12">
             ...
             <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="all-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                   <div class="row">
                      <div class="col-lg-4">
                         <div class="image-container aos-init aos-animate" data-aos="zoom-in">
                            <img src="img/image-1.jpeg" alt="img" class="img-fluid">
                            <div class="overlay_content">
                               <a href="img/image-2.jpeg" class="icon" data-rel="lightcase:myCollection:slideshow">
                               <i class="fa-solid fa-plus"></i>
                               </a>
                               <div class="project-desc content-text">
                                  <a href="#">
                      ...
                      <div class="col-lg-4">
                         <div class="image-container aos-init aos-animate" data-aos="zoom-in">
                            <img src="img/image-2.jpeg" alt="img one" class="img-fluid">
                            <div class="overlay_content">
                               <a href="img/image-2.jpeg" class="icon" data-rel="lightcase:myCollection:slideshow">
                               <i class="fa-solid fa-plus"></i>
                               </a>
                               <div class="project-desc content-text"><a href="#">
                                  <span class="ltext">Woods Quay | Panbeton® bar & fireplace cladding </span><br><span>Paris - France</span>
                                  </a>
                               </div>
                            </div>
                         </div>
                      ...
                      <div class="col-lg-4">
                         <div class="image-container aos-init aos-animate" data-aos="zoom-in">
                            ...
                            <!-- </a> -->
                            <div class="overlay_content">
                               <a href="img/image-3.jpeg" class="icon" data-rel="lightcase:myCollection:slideshow">
                               <i class="fa-solid fa-plus"></i>
                               </a>
                               <div class="project-desc content-text">
                                  <a href="#">
                      ...
                      <div class="col-lg-4">
                         <div class="image-container aos-init aos-animate" data-aos="zoom-in">
                            ...
                            <div class="overlay_content">
                               <a href="img/image-4.jpeg" class="icon" data-rel="lightcase:myCollection:slideshow">
                               <i class="fa-solid fa-plus"></i>
                               </a>
                               <div class="project-desc content-text">
                                  <a href="#">
                      ...
                      <div class="col-lg-4">
                         <div class="image-container aos-init aos-animate" data-aos="zoom-in">
                            ...
                            <!-- </a> -->
                            <div class="overlay_content">
                               <a href="img/image-5.jpeg" class="icon" data-rel="lightcase:myCollection:slideshow">
                               <i class="fa-solid fa-plus"></i>
                               </a>
                               <div class="project-desc content-text">
                                  <a href="#">
                      ...
                      <div class="col-lg-4">
                         <div class="image-container aos-init aos-animate" data-aos="zoom-in">
                            ...
                            <!-- </a> -->
                            <div class="overlay_content">
                               <a href="img/image-6.jpeg" class="icon" data-rel="lightcase:myCollection:slideshow">
                               <i class="fa-solid fa-plus"></i>
                               </a>
                               <div class="project-desc content-text">
                                  <a href="#">
                      ...
                      <div class="col-lg-4">
                         <div class="image-container aos-init aos-animate" data-aos="zoom-in">
                            ...
                            <!-- </a> -->
                            <div class="overlay_content">
                               <a href="img/image-7.jpeg" class="icon" data-rel="lightcase:myCollection:slideshow">
                               <i class="fa-solid fa-plus"></i>
                               </a>
                               <div class="project-desc content-text">
                                  <a href="#">
             ...
             <div class="d-flex justify-content-center">
               <a href="product.html" class="btn view-all btnstyle">
                 View All
               </a>
             </div>
          </div>
